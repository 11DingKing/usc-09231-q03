...
This mirrors the upstream beets ``test/conftest.py`` (version 2.14.1),
which provides the fixtures that the mixins in ``beets.test.helper``
rely on -- most notably the ``io`` fixture required by ``IOMixin``.
"""
